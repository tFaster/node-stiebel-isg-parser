[![npm (scoped)](https://img.shields.io/npm/v/@tfaster/node-stiebel-isg-parser?label=@tfaster/node-stiebel-isg-parser&style=flat-square)](https://www.npmjs.com/package/@tfaster/node-stiebel-isg-parser)
